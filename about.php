...
<body>
    ...
    <section class="flex items-center bg-white xl:h-screen font-poppins dark:bg-gray-800 ">
        <div class="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
            <div class="flex flex-wrap ">
                ...
                <div class="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                    ...
                    <p class="mb-6 text-base leading-7 text-gray-500 dark:text-gray-400 text-justify">
                    ...
                    <!-- <a href="#" class="px-4 py-2 text-gray-100 bg-blue-700 rounded dark:bg-blue-700 dark:hover:bg-blue-800 hover:bg-blue-800">
                        Learn more
                    </a> -->
                </div>
            </div>
